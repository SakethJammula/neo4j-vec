...
# ## Experiment to predict citation relationship between two article nodes based on node embeddings
...
# #### The above code implies that we have 264382 node embeddings that represent connected nodes (label = 1)
